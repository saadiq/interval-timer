...
const WorkoutPageContent: React.FC = () => {
  ...
  if (isLoading) {
    return <div className="flex justify-center items-center min-h-screen">Loading workout...</div>;
  }
  ...
  if (notFound) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen p-4">
        ...
        <p className="text-lg mb-4">There is no workout available for {formatDate(currentDate)}.</p>
        <Link 
          href="/workouts" 
  ...
  if (!workout) {
    return <div className="flex justify-center items-center min-h-screen">No workout available for the selected date.</div>;
  }
