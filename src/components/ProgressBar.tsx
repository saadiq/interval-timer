  ...
  return (
    <div className="mb-6 space-y-3" role="region" aria-labelledby="workout-progress">
      ...
      <div className="flex justify-between items-center text-sm">
        <span className="text-muted-foreground">{Math.round(progress * 100)}% complete</span>
        <span className="text-muted-foreground">{formatTime(workout.duration)} total</span>
      </div>
      ...
      >
        ...
        {sections.map((section, index) => {
          ...
          return (
            <div
              key={index}
              data-color={section.color.replace('bg-', '')}
      ...
      <div className="flex justify-between items-center text-xs">
        <div className="flex items-center space-x-1">
          <div className="w-3 h-3 rounded-full" data-color="amber-400"></div>
        ...
        <div className="flex items-center space-x-1">
          <div className="w-3 h-3 rounded-full" data-color="slate-400"></div>
